...
function getWeekNumberByDate(date) {
  ...
  const diffInMilliseconds = Math.floor(date - firstDay);
  const dayDifference = diffInMilliseconds / MILLISECONDS_IN_A_DAY + 1;

  const weekNumber = Math.ceil(dayDifference / 7);
